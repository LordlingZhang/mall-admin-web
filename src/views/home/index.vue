      ...
      <el-row :gutter="20">
        <el-col :span="6">
          <div class="total-frame">
            ...
            <div class="total-title">今日支付成功总数</div>
            <div class="total-value">666</div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="total-frame">
            <img :src="img_home_order" class="total-icon">
            <div class="total-title">今日支付失败总数</div>
        ...
        <el-col :span="6">
          <div class="total-frame">
            <img :src="img_home_order" class="total-icon">
            <div class="total-title">今日支付滞留中总数</div>
        ...
        <el-col :span="6">
          <div class="total-frame">
            ...
            <div class="total-title">今日支付总额</div>
